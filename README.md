...
- [2026-03-13] [ ] Fix the bug on Windows when root is reached (C:) seems to fail
- [2026-03-13] [ ] Fix the bug on Linux where it seems root folders are seen as files for some reason.
